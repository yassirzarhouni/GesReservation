...
<ul class="uk-nav uk-nav-primary uk-nav-center uk-margin-auto-vertical">
    <div class="nav-text"><a href="{{url('/home/vehicule')}}">Mes vehicules</a> </div>
    <div class="nav-text"><a href="{{url('/home/assur')}}">Mes assurances</a> </div>
    <div class="nav-text"><a href="">Mes assurances</a> </div>
    <div class="nav-text"><a href="">Les reponses des agences</a> </div>
    <div class="nav-text">
